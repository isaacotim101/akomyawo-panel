    ...
    fetch(`https://african-hearts-api.vercel.app/api/v1/updates/${id}`)
      ...
      .then((responseData) => {
        ...
        if (responseData) {
          ...
          setTitle(responseData.update_title);
          setAuthor(responseData.update_auther);
          setDescription(responseData.update_description);
          setImage(responseData.update_featured_image);
        } else {
  ...
  const handleSubmit = () => {
    ...
    fetch(`https://african-hearts-api.vercel.app/api/v1/updates/${id}`, {
      ...
      body: JSON.stringify({
        update_title,
        update_auther,
        update_description, // Send updated content as is
