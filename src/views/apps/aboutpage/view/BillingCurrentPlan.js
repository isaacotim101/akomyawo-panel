          ...
          <Row>
            <Col md='6'>
              <div className='mb-2 pb-50'>
                ...
                <span>{data && data.homepage_header}</span> {/* Access data.about_header */}
              </div>
              <div className='mb-2 pb-50'>
                <h5>Mission</h5>
                <span>{data && data.homepage_mission}</span>
              </div>
              <div className='mb-2 pb-50'>
                <h5>Vision</h5>
                <span>{data && data.homepage_vision}</span>
              </div>
